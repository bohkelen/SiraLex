...
- **Next UX2 slice:** UX2I6B2 — Learning Data / Backup & Restore Surface (do not combine with dictionary management).
...
- **Product-build track after PVR1:** PV1B (physical Android / broader device share matrix).
