...
const MESSAGES = {
  en: {
    ...
    "dictionaries.installedState": "Installed",
    "dictionaries.savedDataRetained": "Saved learning data and local feedback are kept.",
    "dictionaries.removeConfirm":
      "Remove “{name}” from this device? Your saved words, review progress, corrections, and search feedback will be kept.",
    "dictionaries.advanced": "Advanced",
    "dictionaries.dataManagement": "Data management",
    "dictionaries.dataManagementHelp":
      "This permanently deletes the whole local database, including your saved vocabulary, review progress, corrections, search feedback, and preferences. It is not the same as updating or removing one dictionary. Export Learning data, correction drafts, and search feedback first if you need them.",
    ...
    "dictionaryUpdate.notNow": "Not now",
    "dictionaryUpdate.cancel": "Cancel",
    "dictionaryUpdate.confirmTitle": "Update dictionary?",
    ...
    "dictionaryUpdate.progress.verifying": "Checking dictionary files…",
    "dictionaryUpdate.progress.installing": "Installing new version…",
    "dictionaryUpdate.progress.installingPercent": "Installing new version… {percent}%",
    ...
    "dictionaryUpdate.failureBody": "Your current dictionary is still available.",
    "dictionaryUpdate.offlineRequired": "A network connection is required to download the dictionary update.",
    "dictionaryUpdate.retry": "Try again",
    "dictionaryUpdate.close": "Close",
    "dictionaryUpdate.continue": "Continue",
    "dictionaryUpdate.reinstall": "Reinstall dictionary",
    "dictionaryUpdate.reinstallHelp":
      "Reinstalling downloads a fresh copy of this dictionary. Your saved vocabulary, review progress, corrections, and search feedback will remain.",
    "search.title": "Search",
    ...
    "lookup.lang.fr": "French",
    "lookup.lang.en": "English",
    "lookup.lang.mnk": "Maninka",
    "entry.translationLabel.fr": "French translation",
    "entry.translationLabel.en": "English translation",
    "lookup.partnerSelect": "Choose search language",
    ...
    // bundle.removeConfirm retained for advanced/dev paths; consumer remove uses dictionaries.removeConfirm.
    ...
    "progress.consumer.downloading": "Downloading dictionary…",
    "progress.consumer.verifying": "Checking dictionary files…",
    "progress.consumer.installing": "Installing dictionary…",
    "progress.consumer.cleanup": "Finishing install…",
    ...
    "search.suggestionsHeading": "Suggestions",
    "search.suggestionAria": "Search {suggestion}",
    "search.resultMeta": "{count} results",
    "search.separatorVariantMeta": "Showing results for \"{query}\"",
  ...
  fr: {
    ...
    "nav.home": "Accueil SiraLex — Recherche",
    ...
    "dictionaries.installedState": "Installé",
    "dictionaries.savedDataRetained":
      "Les données d’apprentissage enregistrées et les retours locaux sont conservés.",
    "dictionaries.removeConfirm":
      "Retirer « {name} » de cet appareil ? Vos mots enregistrés, votre progression de révision, vos corrections et vos retours de recherche seront conservés.",
    "dictionaries.advanced": "Avancé",
    "dictionaries.dataManagement": "Gestion des données",
    "dictionaries.dataManagementHelp":
      "Cette action supprime définitivement toute la base de données locale, y compris votre vocabulaire enregistré, votre progression de révision, vos corrections, vos retours de recherche et vos préférences. Ce n’est pas la même chose qu’une mise à jour ou le retrait d’un dictionnaire. Exportez d’abord les données d’apprentissage, les brouillons de correction et les retours de recherche si vous en avez besoin.",
    ...
    "dictionaryUpdate.notNow": "Pas maintenant",
    "dictionaryUpdate.cancel": "Annuler",
    "dictionaryUpdate.confirmTitle": "Mettre à jour le dictionnaire ?",
    "dictionaryUpdate.confirmBody":
    ...
    "dictionaryUpdate.progress.verifying": "Vérification des fichiers du dictionnaire…",
    "dictionaryUpdate.progress.installing": "Installation de la nouvelle version…",
    "dictionaryUpdate.progress.installingPercent": "Installation de la nouvelle version… {percent} %",
    ...
    "dictionaryUpdate.failureBody": "Votre dictionnaire actuel est toujours disponible.",
    "dictionaryUpdate.offlineRequired":
      "Une connexion réseau est nécessaire pour télécharger la mise à jour du dictionnaire.",
    "dictionaryUpdate.retry": "Réessayer",
    "dictionaryUpdate.close": "Fermer",
    "dictionaryUpdate.continue": "Continuer",
    "dictionaryUpdate.reinstall": "Réinstaller le dictionnaire",
    "dictionaryUpdate.reinstallHelp":
      "La réinstallation télécharge une nouvelle copie de ce dictionnaire. Votre vocabulaire enregistré, votre progression de révision, vos corrections et vos retours de recherche restent en place.",
    ...
    "lookup.lang.fr": "Français",
    "lookup.lang.en": "Anglais",
    "lookup.lang.mnk": "Maninka",
    "entry.translationLabel.fr": "Traduction française",
    "entry.translationLabel.en": "Traduction anglaise",
    "lookup.partnerSelect": "Choisir la langue de recherche",
    ...
    "progress.consumer.downloading": "Téléchargement du dictionnaire…",
    "progress.consumer.verifying": "Vérification des fichiers du dictionnaire…",
    "progress.consumer.installing": "Installation du dictionnaire…",
    "progress.consumer.cleanup": "Finalisation de l’installation…",
    ...
    "search.noExactMatch": "Aucun résultat exact.",
    "search.suggestionsHeading": "Suggestions",
    "search.suggestionAria": "Chercher « {suggestion} »",
    "search.resultMeta": "{count} résultats",
    "search.separatorVariantMeta": "Résultats pour « {query} »",
